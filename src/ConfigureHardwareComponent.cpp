  ...
  parentCANDrivers(canDrivers)
{
	...
	hardwareInterfaceSelector.addItemList({ "PEAK PCAN USB", "Innomaker2CAN", "TouCAN", "SysTec","Kvaser VCan1" }, 1);
#else
	hardwareInterfaceSelector.addItemList({ "PEAK PCAN USB", "Innomaker2CAN (not supported with mingw)", "TouCAN", "SysTec","Kvaser VCan1 }, 1);
#endif
	int selectedID = 1;
